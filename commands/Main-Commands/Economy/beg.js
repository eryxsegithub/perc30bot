...
module.exports = {
    ...
    callback: (message, args) => {
        ...
        if(begtime !== null && timeout - (Date.now() - begtime) > 0) {
            ...
            .setColor('RANDOM')
            .setDescription(`
Already Begged Loser, Beg Again In **${timeleft.seconds} Seconds**
...
**${names[name]}**: ${gave[give]} **$${amount}** To <@${user.user.id}>
                ...
                let notgave = [
                    `Dumb ass boy fuck on somewhere`,
                    `Im relly bouta get packing on ya ass`,
                    `You dirty bum bitch`,
                    `Finna smack you in yo uvula boy`,
                    `Fuck up son`
                ]
